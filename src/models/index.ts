...
export { default as CyberpunkCar } from './cyberpunk_car'
...
export { default as LotusEspritHover } from './lotus_esprit_hover'
export { default as SpaceFighter } from './space_fighter'
