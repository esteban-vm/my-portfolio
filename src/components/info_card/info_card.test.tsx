import { screen, within, withGraphicsContext } from '@/tests'
...
describe(`${InfoCard.name}:`, () => {
  ...
  it('should not render any links without passing href', () => {
    void ({ asFragment } = withGraphicsContext(<InfoCard mainText={mainText} />))
  ...
  it('should render a link by passing href', () => {
    void ({ asFragment } = withGraphicsContext(<InfoCard href='/' mainText={mainText} />))
